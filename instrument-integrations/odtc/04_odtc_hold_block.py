...
Used two ways in the ResolveDNA workflow:

  - TAS-068.5 II.17 says to start the DNA Amplification program, let the block reach
...
Two reasons, both of which will burn you.
  ...
  2. set_block_temperature([30.0]) sets the lid to 105 C, unless a lid target happens
     ...
     The ResolveDNA WGA hold wants a 70 C lid (TAS-068.5 Table 1). Call the two
...
async def main():
    ...
    parser.add_argument("--lid-c", type=float, required=True,
                        help="lid set point. TAS-068.5: 70 C for WGA, 105 C for the rest")
