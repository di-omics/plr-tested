"""
odtc_protocols.py - whole-genome sequencing thermal programs expressed as
PyLabRobot Protocol objects for the Inheco ODTC.
...
Primary source
--------------
  Authorized WGS/WGA workflow source, revision 05/2025.
...
# The block starts a method from wherever it happens to be. authorized WGS/WGA workflow source never specifies
...
# ===========================================================================
# Targeted PCR library preparation. A DIFFERENT protocol from the authorized WGS/WGA workflow source
# programs above.
#
...
#     heated-lid temperature for Q5 PCR and matches the authorized WGS/WGA workflow source LIB-AMP program,
