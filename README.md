...
- [`hamilton-star/`](hamilton-star) - protocols and validation scripts for a
  ...
  Whole-genome sequencing and PCR-enrichment liquid handling,
...
- [`packages/`](packages) - self-contained, QC-gated assay products built on the
  ...
  - [`sequencing-validation/`](packages/sequencing-validation) - QC-gated
    whole-genome sequencing and PCR-enrichment hardware validation.
  - [`methylation_seq/`](packages/methylation_seq) - QC-gated methylation-sequencing workflow with fragmentation: sparse
...
- Single-cell WGS preparation discards tips and never returns them. Carryover is fatal to
