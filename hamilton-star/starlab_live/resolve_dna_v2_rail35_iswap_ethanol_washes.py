...
# ResolveDNA WGS PTA Automation - V2 rail35 integrated scaffold
# Integrates:
...
async def assign_deck(lh: LiquidHandler, plate_start: str = "work") -> Dict[str, object]:
    print("Assigning ResolveDNA V2 rail35 deck resources...")
...
async def main():
    parser = argparse.ArgumentParser(description="ResolveDNA V2 rail35 p10/p50 + iSWAP + p300 ethanol wash scaffold.")
