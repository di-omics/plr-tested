...
# for all three. It is the ampseq PCR1 cleanup script (02_ampseq_pcr1_cleanup_col1_dry_v2_
...
#   rail35 pos2 = magnet, holding Cor_96_wellplate_360ul_Fb moved here by iSWAP, column 1
...
# transfer, and is left as an operator/off-deck step exactly as in the ampseq cleanup. Bead
...
# The moving plate is modeled as Cor_96_wellplate_360ul_Fb to match every iSWAP leg in
# the full EM-seq choreography. This resolves the previous cross-script plate-model
# mismatch for the dry rehearsal; wet cleanup heights still require dye tuning.
...
async def assign_deck(lh: LiquidHandler, cleanup: Cleanup) -> Dict[str, object]:
    ...
    mag_plate = Cor_96_wellplate_360ul_Fb(name="rail35_pos2_emseq_cleanup_mag_cor_360_96wp")
    ...
    print("  rail35 pos2 = magnet + Cor_96_wellplate_360ul_Fb work plate, column 1")
...
# so heights can be tuned one step at a time on hardware (the same granularity the ampseq
