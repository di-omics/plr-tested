...
# ResolveDNA V2 production-style scaffold with explicit tip-column advancement.
...
async def main():
    parser = argparse.ArgumentParser(description="ResolveDNA V2 production-style tip-advance scaffold.")
