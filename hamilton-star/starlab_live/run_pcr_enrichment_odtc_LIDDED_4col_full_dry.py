...
# PCR enrichment column-1 full choreography WITH the ODTC thermocycler handoffs AND
# the lid-on / lid-off legs wired around each ODTC trip.
#
# This is the LIDDED variant of run_pcr_enrichment_odtc_1col_full_dry.py. Same 9-leg protocol
...
PCR1_MM = ROOT / "01_pcr_enrichment_round1_mastermix_4col_DRY.py"
PCR2_MM = ROOT / "03_pcr_enrichment_round2_mastermix_4col_DRY.py"
CLEANUP = ROOT / "02_pcr_enrichment_round1_cleanup_4col_DRY.py"
...
STEPS = [
    ...
    ("STEP 5: PCR1 cleanup all-dry on the magnet, cols 1-4 (operator-profile sequence)",
...
def main():
    parser = argparse.ArgumentParser(
        description="LIDDED PCR enrichment columns 1-4 choreography with ODTC handoffs, dry (tips returned)."
    )
    parser.add_argument(
        "--confirm",
        default="",
        help="Required to run on hardware: --confirm RUN_PCR_ENRICHMENT_ODTC_LIDDED_4COL",
    )
    args = parser.parse_args()

    print("")
    print("FULL PCR ENRICHMENT + ODTC CHOREOGRAPHY, COLUMNS 1-4, LIDDED, DRY (tips returned)")
    ...
    if args.confirm != "RUN_PCR_ENRICHMENT_ODTC_LIDDED_4COL":
        print("")
        ...
        print("Add: --confirm RUN_PCR_ENRICHMENT_ODTC_LIDDED_4COL")
    ...
    print("")
    print("SUCCESS: full LIDDED PCR enrichment + ODTC choreography completed for columns 1-4 (32 reactions). Plate back on rail35 pos0, lid on pos4.")
