...
def main():
    parser = argparse.ArgumentParser(
        description="Ampseq PCR1 cleanup integrated dry wrapper: iSWAP rail35 pos0 -> pos2 mag, then cleanup all-dry."
    )
    parser.add_argument(
        "--mode",
    ...
    print("")
    print("SUCCESS: integrated ampseq PCR1 cleanup dry wrapper completed.")
