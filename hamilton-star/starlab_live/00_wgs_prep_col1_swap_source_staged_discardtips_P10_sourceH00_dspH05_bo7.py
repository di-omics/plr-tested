...
async def main():
    parser = argparse.ArgumentParser(description="validation WGS preparation beginning staged additions: lysis and reaction mix, swap-source discard-tip version.")
