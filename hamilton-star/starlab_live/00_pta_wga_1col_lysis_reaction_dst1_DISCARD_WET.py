...
# - DISCARD tips always; --return-tips is rejected (single-cell PTA carryover is fatal).
# - Modes: lysis (3.0 uL) and reaction (6.0 uL), run as SEPARATE processes.
#   Biology order (TAS-068.5): add lysis -> operator seal/spin -> HHS 20 min at 1400 rpm RT ->
