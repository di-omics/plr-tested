...
def main():
    ...
    print("")
    print("FULL PCR ENRICHMENT + ODTC CHOREOGRAPHY, COLUMN 1, LIDDED, DRY (tips returned)")
    ...
    print("")
    print("SUCCESS: full LIDDED PCR enrichment + ODTC column-1 choreography completed. Plate back on rail35 pos0, lid on pos4.")
