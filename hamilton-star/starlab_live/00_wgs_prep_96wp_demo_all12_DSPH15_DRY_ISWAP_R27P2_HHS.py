...
# whole-genome sequencing preparation sequencing validation - WGS preparation beginning
# WGS preparation SOURCE-TO-WORK LOCK 2026-05-12:
# - Modes are lysis and reaction for the beginning WGS preparation workflow.
# - lysis adds the operator-profile stage 1 volume using p10 tip column 1.
# - reaction adds the operator-profile stage 2 volume using p10 tip column 2.
...
# - Water test confirmed the destination prefill geometry used by the operator profile.
...
# - Tip selection follows the operator profile and validated pipette envelope.
#
...
STEPS = {
    "lysis": Step(
        ...
        VOL_LYSIS,
        "p10",
        "Load source rail35 pos1 column 1 with the operator-approved stage 1 liquid. Prepare the destination according to the local method.",
        "Complete the operator-approved stage 1 handoff before continuing.",
    ),
    "reaction": Step(
        "reaction",
        "WGS preparation reaction mix",
        VOL_REACTION,
        "p10",
        "Load source rail35 pos1 column 1 with the operator-approved stage 2 liquid. Confirm the prior stage is complete.",
        "Complete the operator-approved stage 2 handoff before continuing.",
    ),
}
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning sequencing validation WGS preparation deck: SWAP-SOURCE column-1 DISCARD-TIP version...")
