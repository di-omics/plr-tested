...
def main():
    parser = argparse.ArgumentParser(
        description="Ampseq PCR1 cleanup full dry wrapper: iSWAP pos0 -> mag, cleanup all-dry, iSWAP mag -> pos0."
    )
    parser.add_argument(
        "--mode",
    ...
    print("")
    print("SUCCESS: full ampseq PCR1 cleanup iSWAP all-dry workflow completed.")
