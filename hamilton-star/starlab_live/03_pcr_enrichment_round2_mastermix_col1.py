...
# PCR enrichment library preparation - round 2 reagent addition, column 1 only
#
# Purpose:
# - Keep the existing WGS/validation deck unchanged.
# - Second low-risk PCR enrichment automation target: add an operator-prepared round 2 reagent.
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning PCR enrichment round 2 deck: WGS/validation compatible column-1 layout...")
    ...
    print("  source col 1 A-H contains the operator-approved PCR enrichment round 2 reagent")
...
async def main():
    parser = argparse.ArgumentParser(
        description="PCR enrichment round 2 reagent addition, column 1, WGS/validation compatible deck."
    )
