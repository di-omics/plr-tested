...
# Amplicon-seq Library Prep - PCR1 cleanup dry motion scaffold V2 p50-low, column 1 only
#
# Purpose:
...
# 02_ampseq_pcr1_cleanup_col1_dry_v2_p50low.py (the cleanup leg of the 13/13 build at tag
# ampseq-lidded-inwellmix-2026-07-16) and changed in ONE respect: run_all_dry now loops its
...
#      resolve_dna_v2_p50only_2rack_4col_discardtips_h7_bo6.py:134.
...
async def main():
    parser = argparse.ArgumentParser(description="Ampseq PCR1 cleanup dry-offset/motion test V2 p50-low: mag pos2 + trough pos3.")
    parser.add_argument(
        "--mode",
