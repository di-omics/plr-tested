...
def build_plan(sim_lh: bool):
    ...
    def cleanup(name):
        ...
        # discard for real cleanup runs). A real run drops the --return-tips.
...
def build_deck_preflight():
    ...
    return [
        ...
        ("run", "magnetic cleanup deck assignment",
...
def main():
    parser = argparse.ArgumentParser(
        description="methylation-sequencing workflow (fragmentation-coupled) column-1 full choreography with ODTC and magnetic-cleanup handoffs, dry."
    )
    ...
    print("Reagent adds -> ODTC out/back (x8 programs) -> 3x magnetic-cleanup out/back.")
