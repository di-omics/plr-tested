...
#
# Based on the 9-leg, non-lidded single-home V2 prototype and extended with the
# four lid legs, so it is the single-home
...
# the teach points, and ONLY THEN  --mode run --confirm RUN_TARGETED_PCR_ODTC_LIDDED_V2 on
...
# Confirm gate
# ---------------------------------------------------------------------------
CONFIRM_TOKEN = "RUN_TARGETED_PCR_ODTC_LIDDED_V2"
...
def parse_args():
    p = argparse.ArgumentParser(
        description=(
            "Single-home V2 LIDDED targeted PCR column-1 + ODTC choreography (dry, tips returned). "
