# whole-genome amplification + HHS lidded single-column dry run card
...
This card covers dry whole-genome amplification pipetting followed by the mechanical HHS round trip:

1. 3.0 uL lysis motion, source column 1 to work column 1
2. 6.0 uL reaction motion, source column 3 to work column 1
...
- Runner: `starlab_live/run_pta_pipetting_hhs_LIDDED_1col_dry.py`
...
validated whole-genome amplification pipetting script uses CellTreat, while the earlier HHS lid mover
...
```bash
python starlab_live/run_pta_pipetting_hhs_LIDDED_1col_dry.py --stage plan
```
...
```bash
python starlab_live/run_pta_pipetting_hhs_LIDDED_1col_dry.py \
...
```bash
./run_on_pi.sh starlab_live/run_pta_pipetting_hhs_LIDDED_1col_dry.py \
...
### Stage A: whole-genome amplification dry pipetting and plate forward

```bash
./run_on_pi.sh starlab_live/run_pta_pipetting_hhs_LIDDED_1col_dry.py \
  --backend star --stage pta-forward \
