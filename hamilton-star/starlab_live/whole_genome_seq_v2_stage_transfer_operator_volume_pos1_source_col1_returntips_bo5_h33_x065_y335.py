...
# -----------------------------------------------------------------------------
# WGS preparation V2 stage-transfer smoke test
#
# Purpose:
# - One isolated operator-defined transfer before building the rest.
# - Transfer volume comes from the approved local method profile.
...
#
# Biological composition is intentionally kept in the operator-approved local SOP.
#
# Deck:
...
WORK_96WP_DSP_HEIGHT = [3.3] * 8
WORK_96WP_DSP_OFFSETS = [Coordinate(-0.65, 3.35, 0.0)] * 8

SOURCE_96WP_ASP_HEIGHT = [3.3] * 8
