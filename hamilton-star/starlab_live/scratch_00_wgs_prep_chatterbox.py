...
async def main():
    parser = argparse.ArgumentParser(description="sequencing validation WGS preparation beginning staged additions: lysis and reaction mix, swap-source discard-tip version.")
