...
# WGS preparation / HHS lidded plate ROUND TRIP, combined into one gated runner.
#
...
# Run with       --confirm RUN_WGS_PREP_HHS_LIDDED_ROUNDTRIP  (moves the arm through 4 transfers).

ROOT = Path(__file__).resolve().parent
CONFIRM_TOKEN = "RUN_WGS_PREP_HHS_LIDDED_ROUNDTRIP"
...
def main():
    parser = argparse.ArgumentParser(
        description="WGS preparation/HHS lidded plate round trip (plate in, lid on, delid, plate back), dry."
    )
    ...
    print("")
    print("WGS preparation / HHS LIDDED PLATE ROUND TRIP (dry, sacrificial empty plate)")
    ...
    print("")
    print("SUCCESS: WGS preparation/HHS lidded round trip completed. Plate back on rail35 pos0, lid on pos4.")
