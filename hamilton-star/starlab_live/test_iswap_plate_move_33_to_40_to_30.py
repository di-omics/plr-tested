...
# ---------------------------------------------------------------------
# iSWAP plate move test - current whole-genome sequencing preparation deck
#
# Goal:
...
async def main():
    ...
    try:
        ...
        # Same plate type used in the current whole-genome sequencing preparation LH protocol.
