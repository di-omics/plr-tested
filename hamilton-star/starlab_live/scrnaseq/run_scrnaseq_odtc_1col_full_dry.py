...
def main():
    parser = argparse.ArgumentParser(
        description="scRNA-seq column-1 full choreography with ODTC and SPRI handoffs, dry."
    )
    ...
    print("(the first cleanup may include an operator-defined optional second cleanup stage).")
