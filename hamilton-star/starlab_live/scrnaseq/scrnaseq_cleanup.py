...
# the hardware-confirmed ampseq cleanup), same standard leg set, plus the extra reconstitution
...
# Geometry reused verbatim from the confirmed ampseq cleanup (via emseq_cleanup.py). No
