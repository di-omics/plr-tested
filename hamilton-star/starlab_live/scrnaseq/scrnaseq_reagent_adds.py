...
# pattern as the verified PTA/WGA and ampseq master-mix scripts and the emseq scripts. The
...
# never returned, for real reagent runs (like single-cell PTA). --return-tips is for dry
...
# confirmed ampseq/PTA-WGA column-1 adds (confirmed 2026-06-15 / 2026-05-12), via the emseq
...
# Reused verbatim from the confirmed ampseq/PTA-WGA col-1 adds (via emseq scripts).
