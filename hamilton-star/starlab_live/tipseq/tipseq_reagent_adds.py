...
# pattern as the verified PTA/WGA and ampseq master-mix scripts and the emseq/scrnaseq scripts.
#
...
# ampseq/PTA-WGA column-1 adds (via the emseq/scrnaseq scripts). No new coordinate is invented.
...
# p10 adds stay within the hardware-confirmed PTA envelope: up to 6 uL of liquid plus the 7 uL
# blowout air (the PTA/WGA reaction add, 6 uL p10, is confirmed on hardware; liquid+blowout of
...
# Confirmed p10 ceiling: the PTA/WGA reaction add of 6 uL p10 (blowout 7) is hardware-confirmed.
...
# Reused verbatim from the confirmed ampseq/PTA-WGA col-1 adds (via emseq/scrnaseq scripts).
