...
# pattern as the verified WGS preparation and PCR enrichment master-mix scripts and the methylation sequencing/scRNA-seq scripts.
#
...
#                             0.3 RNase inhibitor (in-vitro transcription mix, E2040S)
#   hexamer       2.5    p10  random hexamer (20 uM)                                  tip-rt-anneal
#   rt-mix        8.5    p50  4 5X first-strand buffer + 2 dNTP (10 mM) + 2 DTT       tip-rt
#                             (100 mM) + 0.5 reverse-transcription enzyme RT (reverse-transcription 639524)
...
#   pcr-mix      24.0    p50  20 high-fidelity PCR mix MM (M0541L) +           tip-pcr
...
# p10 adds stay within the hardware-confirmed WGS preparation envelope: up to 6 uL of liquid plus the 7 uL
...
STEPS: Dict[str, Step] = {
    ...
    "ivt-mix": Step(
        ...
        "T7 IVT mix (in-vitro transcription mix, E2040S): 2 uL NTP (100 mM) + 2 uL 10X T7 reaction buffer + 2 uL "
    ...
    "rt-mix": Step(
        ...
        "(reverse-transcription enzyme, reverse-transcription 639524): 4 uL 5X first-strand buffer + 2 uL dNTP (10 mM) + 2 uL DTT "
        "(100 mM) + 0.5 uL reverse-transcription enzyme RT per reaction.",
    ...
    "pcr-mix": Step(
        ...
        "col 1 with the PCR mix: 20 uL high-fidelity PCR mix MM (M0541L) + 2 uL index primers "
