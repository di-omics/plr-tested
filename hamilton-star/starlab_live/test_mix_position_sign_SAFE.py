...
HOW TO READ THE RESULT
  ...
  Either way, report the observation and STOP. Do not re-run the PCR enrichment mastermix
...
# Deck geometry, identical to the validated PCR enrichment mastermix scripts.
TIP_RAIL = 48
LABWARE_RAIL = 35
P50_TIP_POS = 1
WORK_POS = 0
