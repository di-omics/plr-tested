...
# -----------------------------------------------------------------------------
# WGS preparation V2 Phase 2 smoke test: DNA Prep Master Mix only
#
# Purpose:
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning WGS preparation V2 DNAPREP-only smoke-test deck...")
...
async def main():
    parser = argparse.ArgumentParser(description="WGS preparation V2 DNAPREP-only 3 uL addition smoke test.")
