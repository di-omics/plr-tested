...
MM_SCRIPT = ROOT / "04_ampseq_96wp_pcr1_pcr2_mastermix_DSPH15_DRY.py"
ISWAP_TO_MAG_SCRIPT = ROOT / "test_iswap_plate_rail35pos0_to_rail35pos2_mag_variable.py"
CLEANUP_SCRIPT = ROOT / "02_ampseq_pcr1_cleanup_col1_dry_v2_p50low.py"
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "FULL ampseq built dry choreography: PCR1 MM -> iSWAP to mag -> "
    ...
    print("")
    print("FULL AMPSEQ BUILT DRY CHOREOGRAPHY")
    print("")
    print("Assumptions:")
    ...
    print("")
    print("Dry choreography only. Real wet protocol needs PCR1 thermocycler timing and PCR2 setup timing.")
    print("")
    ...
    if args.pause_after_pcr1_mm:
        input(
            "\nPAUSE after PCR1 MM. For real liquid, thermocycle PCR1/off-deck handling now. "
    ...
    if args.pause_after_cleanup:
        input(
            "\nPAUSE after cleanup return. For real liquid, prepare PCR2 index/product setup now. "
    ...
    print("")
    print("SUCCESS: FULL ampseq built dry choreography completed.")
    print("")
