...
def main():
    parser = argparse.ArgumentParser(
        description="Targeted PCR round 2 column-1 two-part runner: 23 uL MM+primers by p50, then 2 uL sample by p10."
    )
    parser.add_argument(
        "--mode",
        choices=["dry", "wet"],
    ...
    print("")
    print("TARGETED PCR ROUND 2 COLUMN-1 TWO-PART RUNNER")
    print("")
