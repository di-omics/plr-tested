...
# Targeted PCR column-1 full choreography WITH the ODTC thermocycler handoffs AND
# the lid-on / lid-off legs wired around each ODTC trip.
#
# This is the LIDDED variant of run_targeted_pcr_odtc_1col_full_dry.py. Same 9-leg protocol
...
PCR1_MM = ROOT / "01_targeted_pcr_round1_mastermix_4col_DRY.py"
PCR2_MM = ROOT / "03_targeted_pcr_round2_mastermix_4col_DRY.py"
CLEANUP = ROOT / "02_targeted_pcr_round1_cleanup_4col_DRY.py"
...
def main():
    parser = argparse.ArgumentParser(
        description="LIDDED targeted PCR columns 1-4 choreography with ODTC handoffs, dry (tips returned)."
    )
    parser.add_argument(
        "--confirm",
        default="",
        help="Required to run on hardware: --confirm RUN_TARGETED_PCR_ODTC_LIDDED_4COL",
    )
    args = parser.parse_args()

    print("")
    print("FULL TARGETED PCR + ODTC CHOREOGRAPHY, COLUMNS 1-4, LIDDED, DRY (tips returned)")
    ...
    if args.confirm != "RUN_TARGETED_PCR_ODTC_LIDDED_4COL":
        print("")
        ...
        print("Add: --confirm RUN_TARGETED_PCR_ODTC_LIDDED_4COL")
