...
# ResolveDNA Bio Validation 0 - PTA/WGA beginning
#
...
# - Work/destination dispense XY = Coordinate(-0.68, 3.22, 0.0).
# - P10 blowout = 7.0 uL with 1.0 sec post-dispense settle.
# - Default PTA map: lysis p10 col1, reaction p10 col2.
#
...
#
# 03 PRODUCTION staged PTA/WGA source-to-work additions, column 1 only, SWAP-SOURCE + DISCARD-TIPS version.
#
