# whole-genome amplification + HHS lidded dry validation - 2026-07-21
...
- branch: `codex/pta-hhs-lidded-dry-run`
- PyLabRobot: `0.2.1`
...
1. whole-genome amplification lysis 3.0 uL x8 source col1 to work col1, reaction 6.0 uL x8
   source col3 to work col1, returned tips, and plate forward to HHS: exit 0,
