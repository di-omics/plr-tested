...
# -----------------------------------------------------------------------------
# ResolveDNA WGS PTA - NEW DECK BRINGUP / BASIC MOVEMENTS
...
# -----------------------------
# ResolveDNA source layout / volumes
# -----------------------------
...
async def run_resolvedna_addition_scaffold(lh: LiquidHandler, r: Dict[str, object]):
    ...
    print("\n=== ResolveDNA ADDITION SCAFFOLD: small reagent additions with p10 ===")
    await lh.pick_up_tips(r["p10_tips_r42"]["A1:H1"])
    try:
        small_reagents = [
    ...
    print("\n=== ResolveDNA ADDITION SCAFFOLD: 20 uL library amp with p50 ===")
    ...
    print("\n=== ResolveDNA CLEANUP ADDITION SCAFFOLD: trough -> rail35 pos1 mag 96WP placeholder ===")
    await lh.pick_up_tips(r["p300_tips_r42"]["A1:H1"])
    try:
        cleanup_additions = [
    ...
    print("SUCCESS: ResolveDNA new-deck addition scaffold completed.")
    print("NOTE: no cleanup removals, no residual ethanol removal, no final eluate transfer in this file.")


async def main():
    parser = argparse.ArgumentParser(description="STAR new-deck bringup for ResolveDNA WGS PTA automation")
    parser.add_argument(
        "--mode",
