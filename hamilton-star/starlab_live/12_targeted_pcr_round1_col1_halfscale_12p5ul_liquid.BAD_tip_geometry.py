...
async def main():
    parser = argparse.ArgumentParser(
        description="Targeted PCR round 1 half-scale first pass: source rail35 pos1 col1 -> dest rail35 pos0 col1, 12.5 uL x8, discard tips."
    )
    ...
    try:
        ...
        print("")
        print("TARGETED PCR ROUND 1 HALF-SCALE FIRST-COLUMN LIQUID TRANSFER")
        print("")
        print("Deck:")
