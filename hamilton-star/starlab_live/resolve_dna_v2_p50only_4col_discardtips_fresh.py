...
# Run:
#   python resolve_dna_v2_p50only_4col_discardtips_fresh.py --mode deck
#   python resolve_dna_v2_p50only_4col_discardtips_fresh.py
#
# Deck:
...
# P50 handles all source-to-work volumes with 5 uL blowout.
