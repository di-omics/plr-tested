...
# the teach points, and ONLY THEN  --mode run --confirm RUN_PCR_ENRICHMENT_ODTC_LIDDED_V2 on
...
# Confirm gate
# ---------------------------------------------------------------------------
CONFIRM_TOKEN = "RUN_PCR_ENRICHMENT_ODTC_LIDDED_V2"
...
def parse_args():
    p = argparse.ArgumentParser(
        description=(
            "Single-home V2 LIDDED PCR enrichment column-1 + ODTC choreography (dry, tips returned). "
...
async def main():
    ...
    print("")
    print("#" * 88)
    print("# SINGLE-HOME V2  LIDDED PCR enrichment col1 + ODTC  (dry, tips returned)")
    ...
    try:
        ...
        print("")
        print("SUCCESS: full LIDDED PCR enrichment + ODTC column-1 choreography completed in one STAR")
