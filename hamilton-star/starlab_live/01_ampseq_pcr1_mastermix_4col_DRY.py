...
# 01_ampseq_pcr1_mastermix_col1.py at tag ampseq-lidded-inwellmix-2026-07-16 (13/13 clean on
...
# from column 1 into the master mix and thence into every later column. The sample is
# single-cell embryo DNA and CLAUDE.md is explicit that carryover is fatal to single-cell
# work. A wet 4-column version needs FRESH TIPS PER DESTINATION COLUMN (see the
# MultiRackTipCursor in resolve_dna_v2_p50only_2rack_4col_discardtips_h7_bo6.py:134) and a
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    ...
    print(f"  destination cols {DEST_COLS} A-H each start with 2.5 uL template/control")
