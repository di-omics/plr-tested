...
# - PCR1 cleanup target: 25 uL PCR1 + 22.5 uL SPRI magnetic cleanup beads = 0.9X.
...
#
# Reservoir map:
#   A1  = SPRI magnetic cleanup beads / bead mimic
...
# 02_targeted_pcr_round1_cleanup_col1_dry_v2_p50low.py as recorded by the
...
#      reagent; with reagent it is targeted PCR product carryover across all four samples. A wet 4-col
...
ACTIONS = {
    "beads-add-dry": CleanupAction("beads-add-dry", "Add 0.9X SPRI magnetic cleanup beads / bead mimic", "add", TROUGH_BEADS, VOL_BEADS),
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    ...
    print("\nReservoir map:")
    print(f"  {TROUGH_BEADS} = SPRI magnetic cleanup beads / bead mimic")
