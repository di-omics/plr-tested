...
# whole-genome sequencing Validation - WGS preparation beginning
#
...
async def main():
    parser = argparse.ArgumentParser(description="WGS preparation full-plate dry demo: source column 1 to destination columns 1-12 with 1.5 mm destination dispense height.")
