...
# -----------------------------------------------------------------------------
# ResolveDNA WGS PTA - p300 ethanol wash add/remove focused test
...
#
# Protocol context:
# - ResolveDNA cleanup calls for adding 200 uL 80% ethanol to each well on magnet,
...
# A2/A3 map to ethanol 1/2 in prior ResolveDNA scaffold. A12 is waste/sink for test removals.
TROUGH_ETOH1 = "A2"
TROUGH_ETOH2 = "A3"
