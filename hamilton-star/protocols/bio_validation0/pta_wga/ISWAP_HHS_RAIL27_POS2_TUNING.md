# iSWAP HHS rail27 pos2 tuning (Bio Validation 0, PTA/WGA)

Validated iSWAP plate-transfer offsets between the PTA/WGA work position
...
runs the forward move, then the return move, then the ampseq full built dry
