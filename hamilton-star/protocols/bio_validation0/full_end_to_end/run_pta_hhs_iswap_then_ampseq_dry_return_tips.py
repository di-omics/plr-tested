"""Full PTA/HHS iSWAP + ampseq dry choreography runner (Bio Validation 0).
...
Phases:
  ...
  3. ampseq full built dry choreography (09_ampseq_full_built_end_to_end_dry.py)
...
# ampseq full built dry choreography (returns tips; not a discard-tip run).
AMPSEQ_CMD = [
    sys.executable,
    str(AMPSEQ_SCRIPT),
]
