...
Read a plate's per-well dsDNA concentration (PicoGreen), then add a different
...
PicoGreen is a FLUORESCENCE assay (ex/em 480/520). The Tecan's fluorescence path
...
- for a real read: PicoGreen standard series, `--assay-dilution`, kit ex/em - all
  currently tunable placeholders in the gene-edit package, confirm against the insert.
...
./run_on_pi.sh protocols/bio_validation0/normalization/normalize_plate.py \
...
--rfu-csv    rows: well,rfu    with  --standards "0:100,10:150,100:600,1000:5100" --assay-dilution 10
