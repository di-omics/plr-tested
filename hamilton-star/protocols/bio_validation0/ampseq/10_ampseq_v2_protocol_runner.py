...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Ampseq V2 protocol runner. Runs all currently built Hamilton liquid-handling "
    ...
    print("")
    print("AMPSEQ V2 PROTOCOL RUNNER")
    print("")
    ...
    print("")
    print("SUCCESS: Ampseq V2 protocol runner completed all currently built Hamilton LH steps.")
    print("")
