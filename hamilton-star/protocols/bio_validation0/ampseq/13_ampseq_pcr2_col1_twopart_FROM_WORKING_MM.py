...
# Amplicon-seq Library Prep - PCR1 master-mix addition, full 96WP dry demo
#
# Purpose:
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning Amplicon-seq 96WP PCR1/PCR2 master-mix dry deck: WGS/Bio Validation 0 compatible layout...")
...
async def transfer_master_mix_96wp(
    ...
    *,
    ...
    print("")
    print(f"=== AMPSEQ 96WP DRY DEMO: {label} ===")
...
async def main():
    parser = argparse.ArgumentParser(
        description="Ampseq PCR2 col1 two-part setup: sample transfer plus PCR2 MM/primer transfer using working MM geometry."
    )
    parser.add_argument(
        "--mode",
    ...
    try:
        ...
        if args.mode == "full-mm-demo":
            ...
            print("Running full ampseq 96WP dry demo in one STAR init:")
