...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning sequencing validation staged library-prep deck: SWAP-SOURCE column-1 version...")
...
async def main():
    parser = argparse.ArgumentParser(description="sequencing validation staged column-1 library prep additions, swap-source version.")
