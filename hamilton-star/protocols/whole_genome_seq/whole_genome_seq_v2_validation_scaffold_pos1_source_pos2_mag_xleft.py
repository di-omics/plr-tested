...
# -----------------------------------------------------------------------------
# WGS preparation V2 validation / assay validation scaffold: rail35 pos1 source, pos2 mag
#
...
#
# This file is a clean handoff scaffold for a first validation pilot. It should be
...
# Source reagent/source-column pattern. Update labels/volumes for actual validation run.
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning WGS preparation V2 validation scaffold deck...")
...
async def main():
    parser = argparse.ArgumentParser(description="WGS preparation V2 validation scaffold: source pos1 96WP, mag pos2.")
    ...
    try:
        ...
        if args.mode == "full-v2":
            ...
            await move_plate_mag_pos2_to_pos0(lh, r)
            print("\nSUCCESS: full V2 validation scaffold completed.")
            return
