...
def main():
    parser = argparse.ArgumentParser(
        description="PCR enrichment round 1 cleanup full dry wrapper: iSWAP pos0 -> mag, cleanup all-dry, iSWAP mag -> pos0."
    )
    parser.add_argument(
        "--mode",
    ...
    print("")
    print("SUCCESS: full PCR enrichment round 1 cleanup iSWAP all-dry workflow completed.")
