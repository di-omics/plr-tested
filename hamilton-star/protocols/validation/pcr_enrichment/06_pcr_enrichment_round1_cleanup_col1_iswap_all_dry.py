...
def main():
    parser = argparse.ArgumentParser(
        description="PCR enrichment round 1 cleanup integrated dry wrapper: iSWAP rail35 pos0 -> pos2 mag, then cleanup all-dry."
    )
    parser.add_argument(
        "--mode",
    ...
    print("")
    print("SUCCESS: integrated PCR enrichment round 1 cleanup dry wrapper completed.")
