...
- for a real read: the fluorescent dsDNA assay standard series, assay dilution, and
  excitation/emission values in `PLR_METHOD_PARAMETERS_FILE`. All are required,
  have no public defaults, and must be confirmed against the locally approved method.
