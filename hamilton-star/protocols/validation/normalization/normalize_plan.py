...
packages/assay-validation/assay_validation/ works in ng/mL. This module works entirely
...
# ---------------------------------------------------------------------------
# Provenance: the never-invent rule, in code (lean form of the assay-validation one)
# ---------------------------------------------------------------------------
...
# packages/assay-validation/assay_validation/qc_math.py:linear_fit, kept here so this
