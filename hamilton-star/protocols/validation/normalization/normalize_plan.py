...
UNIT DISCIPLINE (a real trap): the fluorescent dsDNA assay curve math in
packages/sequencing-validation/sequencing_validation/ works in ng/mL. This module works entirely
...
# ---------------------------------------------------------------------------
# Provenance: the never-invent rule, in code (lean form of the sequencing-validation one)
# ---------------------------------------------------------------------------
...
# packages/sequencing-validation/sequencing_validation/qc_math.py:linear_fit, kept here so this
...
def concentrations_from_rfu(
    ...
    """Fit the fluorescent dsDNA assay curve and read every well's NEAT concentration in ng/uL.

    The curve is built blank-subtracted (blank = lowest standard if not given),
    matching how a fluorescent dsDNA assay curve is made. Sample RFU is blank-subtracted the same
