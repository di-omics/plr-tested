...
# -----------------------------------------------------------------------------
# ResolveDNA V2 Phase 2 smoke test: DNA Prep Master Mix only
#
# Purpose:
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning ResolveDNA V2 DNAPREP-only smoke-test deck...")
...
async def main():
    parser = argparse.ArgumentParser(description="ResolveDNA V2 DNAPREP-only 3 uL addition smoke test.")
