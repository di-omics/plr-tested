...
# -----------------------------------------------------------------------------
# ResolveDNA V2 truth-set / biovalidation scaffold: rail35 pos1 source, pos2 mag
#
...
async def assign_deck(lh: LiquidHandler) -> Dict[str, object]:
    print("Assigning ResolveDNA V2 truth-set scaffold deck...")
...
async def main():
    parser = argparse.ArgumentParser(description="ResolveDNA V2 truth-set scaffold: source pos1 96WP, mag pos2.")
