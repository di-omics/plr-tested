...
# whole-genome sequencing V2 production-style scaffold with explicit tip-column advancement.
...
async def main():
    parser = argparse.ArgumentParser(description="whole-genome sequencing V2 production-style tip-advance scaffold.")
