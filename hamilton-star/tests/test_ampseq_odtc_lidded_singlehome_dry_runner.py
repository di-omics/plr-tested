...
def load_runner(module_name="ampseq_odtc_lidded_singlehome_test"):
...
class ReleaseGateTests(unittest.TestCase):
    def test_release_tokens_are_literal_locked_and_all_three_are_required(self):
        self.assertEqual(runner.CONFIRM_TOKEN, "RUN_AMPSEQ_ODTC_LIDDED_SINGLEHOME_DRY")
        self.assertEqual(
            runner.DECK_ACK,
...
class ChatterboxSignatureTests(unittest.TestCase):
    def test_full_chatterbox_matches_exact_standalone_cor_motion_trace(self):
        ...
        self.assertIn("SUCCESS: full LIDDED AmpSeq", result.stdout)
