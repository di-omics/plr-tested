...
async def main():
    ...
    try:
        ...
        await transfer_from_trough(lh, trough[TROUGH_ETOH1][0], targets, VOL_ETOH, f"{TROUGH_ETOH1} (operator-approved wash 1)")
        if WASH_COUNT == 2:
            await transfer_from_trough(lh, trough[TROUGH_ETOH2][0], targets, VOL_ETOH, f"{TROUGH_ETOH2} (operator-approved wash 2)")
