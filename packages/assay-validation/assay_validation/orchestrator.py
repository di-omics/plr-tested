...
through every stage, and runs the fixed sequence:
  ...
  Gate 0 lh_qc -> WGS preparation -> Gate 1 -> PCR enrichment -> Gate 2 -> handoff
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "locus": {
                ...
                "pcr_product_bp": self.config.locus.pcr_product_bp,
            },
...
def build_stages(config: RunConfig) -> List[Stage]:
    """The fixed sequence for assay validation."""
    return [
        LiquidHandlingQC(),
        WGSPreparation(),
