...
What lives here:
  ...
  - a plain ordinary-least-squares line fit with R-squared, for the fluorescent dsDNA assay and
...
# ---------------------------------------------------------------------------
# fluorescent dsDNA assay quantitation
# ---------------------------------------------------------------------------
...
def quantitate(fit: LineFit, sample_signal: float, blank: float = 0.0,
    ...
    fluorescent dsDNA assay curve is built (standards are blank-subtracted too). in_curve_range flags
