...
A stage is one span of the flow between two gates: qualify the deck, run WGS preparation, quant the
WGS preparation product, build the library, quant the library, hand off. Each takes a StageContext -
...
post-WGS preparation yield gate does not reach the library prep; the orchestrator narrows
