...
a different wavelength pair. A reference dsDNA standard curve is read on the
...
Assay wavelengths and standard concentrations come from the run's controlled
operator profile. The public package supplies curve fitting and quantitation only.
"""
