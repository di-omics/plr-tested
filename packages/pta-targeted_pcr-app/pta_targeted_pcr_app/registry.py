...
DECK_ID = "pta_targeted_pcr_combined_dry_v1"
...
def _package_root():
    return resources.files("pta_targeted_pcr_app")
...
def release_summary() -> ReleaseSummary:
    ...
    return ReleaseSummary(
        ...
        issues=(),
        message=(
            "Hardware release locked: no validated combined PTA + Targeted PCR dry build "
            "manifest exists."
        ),
    )
