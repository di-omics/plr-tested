# PTA + Targeted PCR bench planner

A local, planning-only wizard for the combined Hamilton STAR PTA + HHS and
...
button remains locked while `pta_targeted_pcr_app/data/releases/` contains no valid
...
[one-column full dry setup guide](../../hamilton-star/starlab_live/PTA_TARGETED_PCR_FULL_DRY_DECK_CHECKLIST.md).

## Run locally

```bash
cd packages/pta-targeted_pcr-app
python3 -m pta_targeted_pcr_app --port 8766
```
