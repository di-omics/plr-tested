...
# A deck good enough to pass at and above a few uL, tight everywhere the PCR enrichment/WGS preparation
...
FLUORESCENT_DSDNA_MODEL = FluorescentDsDNAModel()
