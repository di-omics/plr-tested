...
provenance module. Molecular identity is cited to PubChem and spectral context to the
peer-reviewed PhotochemCAD database. The working concentration and the reader gain are
NOT known until they are read
...
which can also measure accuracy without the top-up assumption, is noted below;
...
EX_MAX_NM = transcribed(
    554, "Rhodamine B absorption spectrum (Taniguchi et al., 2018, PhotochemCAD)",
    unit="nm", name="rhodamine_b_ex_max",
)
EM_MAX_NM = transcribed(
    627, "Rhodamine B fluorescence spectrum (Taniguchi et al., 2018, PhotochemCAD)",
