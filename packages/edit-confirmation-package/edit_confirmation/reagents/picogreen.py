...
genome to be worth sequencing) and after amplicon-seq (is each library in the loading
...
# 1000 ng/mL) and low (about 25 pg/mL to 25 ng/mL) ranges; PTA product and cleaned
...
def quantitate_well(curve: StandardCurve, sample_id: str, well: str,
    ...
    dilution_factor accounts for diluting the sample into the assay (PTA product is
