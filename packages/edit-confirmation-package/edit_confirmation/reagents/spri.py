"""
spri.py - the two SPRI bead cleanups in the targeted PCR flow, as ratios.

The targeted PCR flow cleans up twice: an anti-dimer clean after PCR1 and a final clean
