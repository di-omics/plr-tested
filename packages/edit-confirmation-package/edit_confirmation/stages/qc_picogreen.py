...
The same PicoGreen quant runs after PTA and after amplicon-seq; only the acceptance
...
# Volume the post-PTA yield mass is computed over: the WGA reaction volume.
PTA_PRODUCT_VOLUME_UL = transcribed(
    12.0, "odtc_protocols.py VOL_UL_WGA (TAS-068.5): 12 uL WGA reaction",
