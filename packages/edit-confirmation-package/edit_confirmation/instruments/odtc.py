...
instrument-integrations/odtc/odtc_protocols.py, transcribed from TAS-068.5 and the
amplicon-seq protocol and validated on the instrument. This adapter references those
...
KNOWN_PROGRAMS: Dict[str, ProgramRef] = {
    "wga": ProgramRef(
        "wga", "odtc_protocols.py WGA (TAS-068.5 Table 1); lid 70 C, 12 uL",
        approx_minutes=156.0, note="ResolveDNA DNA amplification; ~2.6 h hold",
    ),
