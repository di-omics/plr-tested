...
CellTreat 350 uL, matching the working AmpSeq liquid-height logic. The reused iSWAP
subprocesses intentionally retain the Cor 360 motion-command stand-in used by the
hardware-proven AmpSeq choreography. P50 source/destination heights are 0.0/1.5 mm;
