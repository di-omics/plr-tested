...
def _targeted_pcr_body(data: dict) -> str:
    ...
    return (
        "<div class='kv'>"
        f"<div class='k'>Locus</div><div class='v'>{_esc(data.get('locus'))} ({_esc(data.get('target_product_bp'))} bp)</div>"
...
<body><div class="wrap">
  ...
  <div class="meta">
    ...
    <span>Locus <b>{_esc(cfg.locus.name)} ({_esc(cfg.locus.target_product_bp)} bp)</b></span>
