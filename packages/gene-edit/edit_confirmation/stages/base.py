...
A stage is one span of the flow between two gates: qualify the deck, run whole-genome amplification, quant the
whole-genome amplification product, build the library, quant the library, hand off. Each takes a StageContext -
...
post-whole-genome amplification yield gate does not reach the library prep; the orchestrator narrows
