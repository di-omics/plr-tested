...
This packages the repo's validated PTA and amplicon-seq work into one QC-gated product:
...
locus: { name: EMX1_site1, amplicon_bp: 250 }
samples:
...
- The **liquid handling, the ODTC thermal programs, and the deck** this points at are
  ...
  `instrument-integrations/odtc/`). The ampseq PCR1 program ran 30 cycles on the ODTC.
...
- **PicoGreen yield floors and the ampseq loading window are TUNABLE defaults**, to be set
