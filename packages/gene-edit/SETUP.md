...
That runs the whole flow (Gate 0 -> PTA -> Gate 1 -> ampseq -> Gate 2 -> handoff) with
...
the PicoGreen yield floor, the ampseq loading window, the PCR1 annealing temperature for
